...
# - DEFAULTUSERS ----------------------------------------
User.find_or_create(:username=>"hans231", :firstname=>"Hans", :email=>"h.hans@hans.de", :admin=>true)
User.find_or_create(:username=>"kenny", :firstname=>"kenny", :email=>"kenny@kenny.de")
User.find_or_create(:username=>"kenner", :firstname=>"kenny", :email=>"kenny@kenny.de")
User.find_or_create(:username=>"kennster", :firstname=>"kenny", :email=>"kenny@kenny.de")
User.find_or_create(:username=>"kennmer", :firstname=>"kenny", :email=>"kenny@kenny.de")


Friendship.find_or_create(:friends_with_id => 1, :friend_of_id => 2)
Friendship.find_or_create(:friends_with_id => 2, :friend_of_id => 1)
Friendship.find_or_create(:friends_with_id => 1, :friend_of_id => 3)
Friendship.find_or_create(:friends_with_id => 1, :friend_of_id => 4)
